...
dennis14e/node-red      - the image to base it on - currently Node-RED v2.2.0 with Node.js 14
```
...
18 May 18:55:17 - [info] Node-RED version: v2.2.0
...
- Alpine Node 14, based on `node:14-alpine`
  - `v2.2.0-minimal`
  - **`latest-minimal`**
  - `v2.2.0-alpine-minimal`
  - `latest-alpine-minimal`
  - `v2.2.0-14-minimal`
  - `latest-14-minimal`
  - `v2.2.0-14-alpine-minimal`
...
- Debian Bullseye, Node 14, based on `node:14-bullseye-slim`
  - `v2.2.0-bullseye-minimal`
  - `latest-bullseye-minimal`
  - `v2.2.0-14-bullseye-minimal`
...
dennis14e/node-red      - the image to base it on - currently Node-RED v2.2.0
