...
dennis14e/node-red      - the image to base it on - currently Node-RED v2.0.3 with Node.js 14
```
...
18 May 18:55:17 - [info] Node-RED version: v2.0.3
...
- `<node-red-version>` is the Node-RED version, can be either latest or v`<node-red-version>`.
  - latest : is the current Node-RED version (currently 2.0.3)
...
- Alpine Node 14, based on `node:14-alpine`
  - `v2.0.3-minimal`
  - **`latest-minimal`**
  - `v2.0.3-alpine-minimal`
  - `latest-alpine-minimal`
  - `v2.0.3-14-minimal`
  - `latest-14-minimal`
  - `v2.0.3-14-alpine-minimal`
...
- Debian Buster, Node 14, based on `node:14-buster-slim`
  - `v2.0.3-buster-minimal`
  - `latest-buster-minimal`
  - `v2.0.3-14-buster-minimal`
...
dennis14e/node-red      - the image to base it on - currently Node-RED v2.0.3
