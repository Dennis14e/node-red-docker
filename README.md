...
dennis14e/node-red      - the image to base it on - currently Node-RED v2.1.3 with Node.js 14
```
...
18 May 18:55:17 - [info] Node-RED version: v2.1.3
...
- Alpine Node 14, based on `node:14-alpine`
  - `v2.1.3-minimal`
  - **`latest-minimal`**
  - `v2.1.3-alpine-minimal`
  - `latest-alpine-minimal`
  - `v2.1.3-14-minimal`
  - `latest-14-minimal`
  - `v2.1.3-14-alpine-minimal`
...
- Debian Bullseye, Node 14, based on `node:14-bullseye-slim`
  - `v2.1.3-bullseye-minimal`
  - `latest-bullseye-minimal`
  - `v2.1.3-14-bullseye-minimal`
...
dennis14e/node-red      - the image to base it on - currently Node-RED v2.1.3
